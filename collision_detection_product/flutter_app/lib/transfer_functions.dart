...
void activateMonitor(context, String device) async {
  ...
  // We specify not to send values through keys publicly
  ...
  var key = AtKey()
    ...
    ..namespace = "socrates9" // set the namespace of AtKey to "socrates9"
    // Can be changed, but must be same as in esp32.
    ..metadata = metaData;
...
Future<String> getAtsignData(context, String sharedByAtsign) async {
  ...
  var metaData = Metadata()
    ..isPublic = false
    ..isEncrypted = true
    ..namespaceAware = false; // Can set namespaceAware to true or false,
  // either works. For more security reasons,
  // set to true.
